...
import tarfile
import typst
from pyobsplot import Obsplot, js, Plot
...
class Obsplot:
    def __init__(self, font="SF Pro Display", font_size=12, margin=4, dpi=300):
        self.font = font
        self.font_size = font_size
        self.margin = margin
        self.dpi = dpi

    def __call__(self, spec, path=None, show=True):
        margin, font, font_size, dpi = self.margin, self.font, self.font_size, self.dpi
